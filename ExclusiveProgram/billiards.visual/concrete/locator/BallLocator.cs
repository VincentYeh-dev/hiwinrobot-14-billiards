...
namespace ExclusiveProgram.puzzle.visual.concrete
{
    public class BallLocator : ILocator
    {
        ...
        public BallLocator(Size minSize, Size maxSize, IPreprocessImpl preProcessImpl, IGrayConversionImpl grayConversionImpl, IThresholdImpl thresholdImpl, IBinaryPreprocessImpl binaryPreprocessImpl, double approx_paramater = 0.005f)
        {
